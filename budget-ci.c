...
static int ciintf_slot_reset(struct dvb_ca_en50221 *ca, int slot)
{
	...
	msleep(10); // modified for smarcam
...
static const struct stb0899_s1_reg tt3200_stb0899_s1_init_1[] = {
	...
	{ STB0899_IRQCFG		, 0x00 },
	{ STB0899_I2CCFG        	, 0x88 },
	{ STB0899_I2CRPT        	, 0x58 }, /* 12k Pullup, Repeater=16, Stop=disabled */ // old 48
	...
	{ STB0899_TSTTNR1        	, 0x0b },
	{ STB0899_TSTTNR2       	, 0x00 },
	{ STB0899_TSTTNR3       	, 0x00 },
...
static const struct stb0899_s1_reg tt3200_stb0899_s1_init_3[] = {
	...
	{ STB0899_TSULC         	, 0x42 },
	{ STB0899_RSLLC         	, 0x41 }, // ex 40 
	{ STB0899_TSLPL			, 0x12 },
	{ STB0899_TSCFGH        	, 0x0c },
	{ STB0899_TSCFGM        	, 0x00 },
	{ STB0899_TSCFGL        	, 0x00 },
	{ STB0899_TSOUT			, 0x7f }, /* 0x0d for CAM */ // ex 4d 
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Michael Hunold, Jack Thomasson, Andrew de Quincey, Knossos, others");
MODULE_DESCRIPTION("like 16.04");
